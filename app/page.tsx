...
export default function Portfolio() {
  // Profile information
  const profileInfo = {
    username: "rojansedhai",
    name: "Rojan Sedhai",
    role: "AWS Solutions Architect/Cloud Trainer",
    ...
    skills: ["AWS", "Terraform", "GitHub", "Training"],
  }
  ...
  const [projects] = useState<Project[]>([
    ...
    },
    {
      ...
      deploymentUrl: "https://vercel.com/rojansedhai/mobile-banking",
    },
    {
      id: "3",
      image: "/placeholder.svg?height=400&width=400",
